...
#define TIMESPAN_NANOSPERMILLISECOND        (TIMESPAN_NANOSPERMICROSECOND * 1000)   /* 1,000,000          */
#define TIMESPAN_NANOSPERSECOND             (TIMESPAN_NANOSPERMILLISECOND * 1000)   /* 1,000,000,000      */
#define TIMESPAN_NANOSPERMINUTE             (TIMESPAN_NANOSPERSECOND * 60)          /* 60,000,000,000     */
#define TIMESPAN_NANOSPERHOUR               (TIMESPAN_NANOSPERMINUTE * 60)          /* 3,600,000,000,000  */
#define TIMESPAN_NANOSPERDAY                (TIMESPAN_NANOSPERHOUR * 24)            /* 86,400,000,000,000 */
