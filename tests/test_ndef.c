...
#include "drivers/rf/pn532/mem_allocator/pn532_mem.h"
...
*/
/**************************************************************************/
TEST( ndef, ndef_createFromValue)
{
...
*/
/**************************************************************************/
TEST( ndef, ndef_createFromRawEx)
{
  pn532_ndef_record_t rec, rec1;
  uint32_t            length;
...
*/
/**************************************************************************/
TEST( ndef, ndef_createFromStream)
{
  pn532_error_t       errorCode;
  pn532_ndef_record_t rec;
...
pn532_error_t fn_fetch(void* pUserData, uint8_t *out_buff, uint32_t length)
{
  memcpy(out_buff, g_buffer + index, length);
  index += length;
  return PN532_ERROR_NONE;
}

TEST_GROUP_RUNNER( ndef)
{
  RUN_TEST_CASE(ndef, createTextRecord);
  RUN_TEST_CASE(ndef, ndef_createFromValue);
  RUN_TEST_CASE(ndef, ndef_update);
  RUN_TEST_CASE(ndef, ndef_createFromRaw);
  RUN_TEST_CASE(ndef, ndef_updatefromRAW);
  RUN_TEST_CASE(ndef, ndef_createFromRawEx);
  RUN_TEST_CASE(ndef, ndef_createFromStream);
  RUN_TEST_CASE(ndef, ndef_linkNextRecord);
  RUN_TEST_CASE(ndef, ndef_getNextRecord);
  RUN_TEST_CASE(ndef, ndef_getRecord);
  RUN_TEST_CASE(ndef, ndef_appendRecord);
}
