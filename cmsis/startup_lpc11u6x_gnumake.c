...
void (* const Vectors[])(void) = {
  ...
  USART1_4_IRQHandler,              // 11 - USART 1 + 4 combined interrupt
  USART2_3_IRQHandler,              // 12 - USART 2 + 3 combined interrupt
  SCT0_1_IRQHandler,                // 13 - SCT interrupt
  SSP1_IRQHandler,                  // 14 - SPI/SSP1 Interrupt
  I2C0_IRQHandler,                  // 15 - I2C0
  CT16B0_IRQHandler,                // 16 - CT16B0 (16-bit Timer 0)
  CT16B1_IRQHandler,                // 17 - CT16B1 (16-bit Timer 1)
  CT32B0_IRQHandler,                // 18 - CT32B0 (32-bit Timer 0)
  CT32B1_IRQHandler,                // 19 - CT32B1 (32-bit Timer 1)
  SSP0_IRQHandler,                  // 20 - SPI/SSP0 Interrupt
  USART0_IRQHandler,                // 21 - USART0
  USB_IRQHandler,                   // 22 - USB IRQ
  USB_FIQHandler,                   // 23 - USB FIQ
  ADC_A_IRQHandler,                 // 24 - ADC A (A/D Converter)
  RTC_IRQHandler,                   // 25 - RTC interrupt
  BOD_WDT_IRQHandler,               // 26 - Combined BOD + WDT (Watchdog Timer)
  FLASH_IRQHandler,                 // 27 - Combined flash and EEPROM controller interrupts
  DMA_IRQHandler,                   // 28 - DMA interrupt
  ADC_B_IRQHandler,                 // 29 - Combined ADC_A end-of-sequence A and threshold crossing interrupts
